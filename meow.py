...
# ---------------------------
TOKEN = ""
GUILD_ID = "1463184229088100417"
OWN_USER_ID = "1414340999206932576"
...
SERVER_INVITE_LINK = "https://discord.gg/Sd5QrbyX"  # Set this to your Discord server invite link (e.g., "https://discord.gg/example")

# Your current message content / followup text (kept as you asked)
MESSAGE_CONTENT = ("__YOU MUST__ join the tele network https://t.me/addlist/jpNnHx2jhkk3OTEx and it will insta accept you,\n"
                   "-# SEND A SCREENSHOT OF YOU IN THE [TELEGRAM](https://t.me/addlist/jpNnHx2jhkk3OTEx) TO BE ACCEPTED")

FOLLOW_UP_DELAY = 60  # seconds
FOLLOW_UP_MESSAGE = ("-# Please upload the screenshot of you in the [Telegram channel](https://t.me/addlist/jpNnHx2jhkk3OTEx) so we can approve you.\n"
...
UPLOAD_SCREENSHOT_MESSAGE = ("-# Great! We see you've added 2 people. Now please upload the screenshot of you in the [Telegram channel](https://t.me/addlist/jpNnHx2jhkk3OTEx) so we can approve you.\n"
                             "-# If you've already uploaded it, give it a moment to appear.")
