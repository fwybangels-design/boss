...
local Window = Rayfield:CreateWindow({
    ...
    KeySystem = true, -- Enable Rayfield's key system
    KeySettings = {
      Title = "Chat Promotion Key",
      Subtitle = "dm gio https://t.me/blehboss",
      Note = "If you want to use the script contact gio on tele", -- Use this to tell the user how to get a key
      FileName = "Key", -- Unique name for saved key so it doesn't conflict
      SaveKey = true, -- User's key will be saved locally
      GrabKeyFromSite = true, -- Grab key from pastebin/github or array of keys
      Key = {"https://pastebin.com/raw/0Wqtqma1"} -- Acceptable keys can be raw URLs or strings
    }
})
...
local function teleportToNewServer()
    ...
    if chosen then
        ...
        if queueteleport and type(queueteleport) == "function" then
            queueteleport([[
wait(1)
loadstring(game:HttpGet("https://raw.githubusercontent.com/fwybangels-design/boss/main/imabosss_with_key.lua"))()
]])
        end
