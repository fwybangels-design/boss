...
local messages = {
    "ageplayer heaven in /late",
    "cnc and ageplay in vcs /late",
    "get active /late",
    "cnc and ageplay in vcs /late",
    "join the new /late",
    "camgir1s in /late jvc",
	"yo jvc rn she going crazy /late",
	"YO WHAT ARE THEY DOING ON CAM /late",
	"BRO WHAT IS SHE DOING ON CAM /late",
	"STAG3 GIRLS IN /late"
}
